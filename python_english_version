...
print("The program builds a chain of words, from the beginning to the end, replacing one letter at each step")
print("Three-letter English words are used")
print("Enter the initial word of the chain (English word of 3 letters):")
process = psutil.Process()
start_word = input()
print("Enter the end word of the chain (English word of 3 letters):")
end_word = input()
